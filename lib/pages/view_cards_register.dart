...
class ViewCardsRegister extends StatefulWidget {
  const ViewCardsRegister({super.key});

  @override
  State<ViewCardsRegister> createState() => _ViewCardsRegisterState();
}

class _ViewCardsRegisterState extends State<ViewCardsRegister>
    with Validations {
  @override
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        ...
                        "Não existe nenhum cartão cadastrado para ser avaliado!",
